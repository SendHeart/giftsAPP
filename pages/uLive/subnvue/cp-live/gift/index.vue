...
<view class="wrap__giftPanel" v-if="showGiftView">
	...
	<view class="gift-head">
		<view class="gift-menu">
			<text class="gm-item gm-item-on">礼物</text>
			<text class="gm-item">背包</text>
		</view>
		<view class="gift-coins">
			<text class="iconfont gc-coin">&#xe756;</text>
			<text class="gc-num">1280</text>
			<text class="gc-recharge">充值</text>
			</view>
		</view>
		...
		<swiper-item v-for="(item,index) in giftList" :key="index">
			<view class="gift__cells">
				...
				<view class="giftitem" @tap="handleGivingGift(item2)">
...
.giftcoin {
	...
	font-size: 22upx; margin-top: 2px;
}
