...
function wxParse(bindName = 'wxParseData', type = 'html', data = '<div class="color:red;">数据不能为空</div>', target, imagePadding) {
  ...
  that.setData(bindData); //if (nowData) {
  //  nowData.content = bindData;
  //} else {
...
function calMoreImageInfo(e, idx, that, bindName) {
  ...
  var recal = wxAutoImageCal(e.detail.width, e.detail.height, that, bindName, temImages[idx]); // temImages[idx].width = recal.imageWidth;
...
function wxAutoImageCal(originalWidth, originalHeight, that, bindName, temImage) {
  ...
  var arr = temImage.attr.style ? temImage.attr.style : 'style="width:';
