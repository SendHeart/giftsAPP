	...
	export default {
		...
		methods: {
			...
			wxParseImgLoad(e) {
				...
				if(styleStr) this.newStyleStr = styleStr+';' ;
				this.newStyleStr += ` ${imageHeightStyle}; width: ${imageWidth}px; padding: 0 ${+padding}px auto;margin-top:-16rpx;`;
				//console.log('styleStr:',styleStr,' newStyleStr:',this.newStyleStr)
			},
			// 计算视觉优先的图片宽高
