<template>
	<view>
		<video :src="src" :controls="controls" :show-play-btn="true" 
			:style="{ height: height }" :loop="false" @waiting="waiting"
			:enable-progress-gesture="false" :objectFit="objectFit" muted="true"
